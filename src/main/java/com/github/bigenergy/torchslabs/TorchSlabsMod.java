...
//import com.github.bigenergy.torchslabs.blocks.bambooblock.BambooBlockCompat;
//import com.github.bigenergy.torchslabs.blocks.buzzierbees.BuzzierBeesCompat;
//import com.github.bigenergy.torchslabs.blocks.buzzierbees.tileentity.BBTileEntities;
//import com.github.bigenergy.torchslabs.blocks.druidcraft.DruidCraftCompat;
//import com.github.bigenergy.torchslabs.blocks.quark.QuarkCompat;
//import com.github.bigenergy.torchslabs.blocks.upgradeaquatic.UACompat;
import com.github.bigenergy.torchslabs.blocks.vanilla.VanillaCompat;
...
{
	public static final String MODID = "torchslabs";
	public static final String NAME = "Torch Slabs Mod";
	...
	public TorchSlabsMod()
	{
		...
		ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, Config.SERVER, "torchslabs-server.toml");
